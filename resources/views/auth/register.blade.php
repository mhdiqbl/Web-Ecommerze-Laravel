                    ...
                    <div class="col-lg-4">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" v-model="email" @change="checkForEmailAvailability()" :class="{ 'is-invalid': this.email_unavailable }" type="email" class="form-control
                            ...
                            <div class="form-group" v-if="is_store_open">
                                ...
                                @error('store_name') is-invalid @enderror" v-model="store_name"
                                id="store_name" name="store_name" required autocomplete autofocus>
